#ifndef VOLUM_SENSOR_H__
#define VOLUM_SENSOR_H__
...
#include "./../filesystem/datatypes.h"
#include "./../config.h"
...
void bioimpedance_init(void);
void bioimpedance_cfg_N(stateMachine_t * sysConfig);
void bioimpedance_measure(acqValues_t * tempacq);
void bioimpedance_getFreqs(uint32_t N, float * freqs);
bool bioimpedance_up(void);

void orientation_init(void);
void orientation_measure(acqValues_t * tempacq);

void battery_init(void);
void battery_measure(acqValues_t * tempacq);
